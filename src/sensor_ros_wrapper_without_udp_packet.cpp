...
class PointCloudPublisher {
    ...
    private:
        ...
        void publish_point_cloud(const char* data, int length) {
            ...
            std::cout<<"=======publish_point_cloud========"<<std::endl;
            ...
            msg.fields.resize(3);
            setup_fields(msg);
            msg.point_step = sizeof(float) * NUM_FLOATS_PER_VECTOR; // 每个点的字节数
            ...
            const float* received_data = reinterpret_cast<const float*>(data); // 不跳过任何数据
